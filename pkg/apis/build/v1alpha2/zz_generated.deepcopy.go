...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *V1Alpha1Binding) DeepCopyInto(out *V1Alpha1Binding) {
	*out = *in
	if in.MetadataRef != nil {
		in, out := &in.MetadataRef, &out.MetadataRef
		*out = new(v1.LocalObjectReference)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new V1Alpha1Binding.
func (in *V1Alpha1Binding) DeepCopy() *V1Alpha1Binding {
	if in == nil {
		return nil
	}
	out := new(V1Alpha1Binding)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in V1Alpha1Bindings) DeepCopyInto(out *V1Alpha1Bindings) {
	{
		in := &in
		*out = make(V1Alpha1Bindings, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
		return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new V1Alpha1Bindings.
func (in V1Alpha1Bindings) DeepCopy() V1Alpha1Bindings {
	if in == nil {
		return nil
	}
	out := new(V1Alpha1Bindings)
	in.DeepCopyInto(out)
	return *out
}
