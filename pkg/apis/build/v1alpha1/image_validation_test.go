...
func testImageValidation(t *testing.T, when spec.G, it spec.S) {
	...
	when("Validate", func() {
		...
		it("multiple sources", func() {
			...
			image.Spec.Source.Registry = &v1alpha1.Registry{
		...
		it("missing source", func() {
			image.Spec.Source = v1alpha1.SourceConfig{}
		...
		it("validates blob url", func() {
			...
			image.Spec.Source.Blob = &v1alpha1.Blob{URL: ""}
		...
		it("validates registry image exists", func() {
			image.Spec.Source.Git = nil
			image.Spec.Source.Registry = &v1alpha1.Registry{Image: ""}
		...
		it("validates registry image valide", func() {
			image.Spec.Source.Git = nil
			image.Spec.Source.Registry = &v1alpha1.Registry{Image: "NotValid@@!"}
